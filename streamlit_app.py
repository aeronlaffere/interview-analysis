...
def segment(audio_file):
    ...
    segment_number = 0
    while duration >= 15:
        segment = audio_file[segment_number *
                             quarter:(segment_number + 1) * quarter]
...
st.sidebar.write(
    "You need an OpenAI API key to run this demo. You can get one [here](https://platform.openai.com/signup).")
st.sidebar.write(
    "This application was developed by [@aeronjl](https://twitter.com/aeronjl) and is open source. You can find the source code [here](https://github.com/aeronlaffere/interview-analysis).")
